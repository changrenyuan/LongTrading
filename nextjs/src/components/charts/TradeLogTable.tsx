          ...
          <TableBody>
            {sortedTrades.map((trade) => (
              <>
                  ...
                  <TableCell className="text-right">
                    {trade.pnl > 0 ? (
                      <span className="text-green-600 font-medium">
                        ...
                        <br />
                        <span className="text-xs">(+{trade.pnl_pct.toFixed(1)}%)</span>
                      </span>
                    ) : trade.pnl < 0 ? (
                ...
                {expandedId === trade.id && (
                  <TableRow key={`${trade.id}-detail`} className="bg-muted/30">
                    <TableCell colSpan={8} className="p-4">
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <span className="ml-2 font-medium">{trade.holding_days} 天</span>
                        </div>
